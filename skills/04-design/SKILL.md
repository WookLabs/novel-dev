...
| style-curator | opus | 문체 설계 + 문체 일관성 자문 | style-guide.json |
| lore-keeper | opus | 세계관 + 관계도 + 정합성 검증 | world.json, relationships.json |
| character-designer | opus | 캐릭터 프로필 + 에이전트 생성 | characters/*.json, agents/characters/*.md |
| arc-designer | opus | 서브아크 + 복선 + 훅 | sub-arcs/*.json, foreshadowing.json, hooks.json |
